...
from ..models import Signal, SignalType, WhaleActivityData
...
class WhaleProcessor:
    ...
    def __init__(self):
        self.whale_threshold = settings.whale_threshold_btc
        self.accumulation_window = settings.accumulation_window_days
